    ...
    <>
      ...
      <main className="md:ml-64 pt-16 min-h-screen p-8 flex items-center justify-center">
        <div className="text-center">
          <span className="material-symbols-outlined text-6xl text-on-surface-variant mb-4">rule</span>
          <h1 className="text-2xl font-bold text-on-surface mb-2">Approvals</h1>
